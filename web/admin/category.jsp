...
<div class="goods_list" id="account_List">
    ...
    <ul class="list_goods_ul">
        ...
        <li>分类名称</li>
        <li>分类级别</li>
        <li><a href="#"><img class="img_icon" src="${pageContext.request.contextPath}/admin/images/edit_icon.png"
                             alt=""></a></li>
        <li><a href="#"><img class="img_icon" src="${pageContext.request.contextPath}/admin/images/delete_icon.png"
                             alt=""></a></li>
    </ul>
