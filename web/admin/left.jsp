...
<ul>
    ...
    <li><a href="${pageContext.request.contextPath}/GoodsServlet?action=getPageData&current=${num}"
           target="mainFrame"><i></i>商品管理</a></li>
    <li><a href="${pageContext.request.contextPath}/AdminServlet?action=getAllAdmin" target="mainFrame"><i></i>用户管理</a>
    </li>
    <li><a href="${pageContext.request.contextPath}/admin/order.jsp" target="mainFrame"><i></i>订单管理</a></li>
    <li><a href="${pageContext.request.contextPath}/admin/category.jsp" target="mainFrame"><i></i>地址管理</a></li>
</ul>
